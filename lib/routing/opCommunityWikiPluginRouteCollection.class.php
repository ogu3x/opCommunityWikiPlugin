...
/**
 * CommunityWikiPlugin route collection.
 *
 * @package    OpenPNE
 * @subpackage routing
 * @author     Kousuke Ebihara <ebihara@tejimaya.com>
 */
class opCommunityWikiPluginRouteCollection extends sfRouteCollection
{
  protected $templates = array(
    ...
    'show' => array(
      ...
      'action'       => 'show',
      'requirements' => array('id' => '\d+'),
      'option'       => array('model' => 'CommunityWiki', 'type' => 'object', 'privilege' => 'view'),
    ),
    'new' => array(
      'url'          => '/new/:id',
      'action'       => 'new',
    ...
    'edit' => array(
      ...
      'action'       => 'edit',
      'requirements' => array('id' => '\d+'),
      'option'       => array('model' => 'CommunityWiki', 'type' => 'object', 'privilege' => 'edit'),
    ),
    'update' => array(
      'url'          => '/update/:id',
      'action'       => 'update',
  ...
  protected function generateRoutes($type)
  {
    foreach ($this->templates as $name => $template)
    {
      ...
      if (isset($template['option']['model']))
      {
        ...
        $template['option']['model'] = str_replace('Wiki', ucfirst($type), $template['option']['model']);
      }
