...
* examples.  Blocks are marked as the string <codehl> on a line by itself,
* followed by the inline code example, and terminated with the string
* </codehl> on a line by itself.  The code example is run through the
...
class Text_Wiki_Parse_Codehl extends Text_Wiki_Parse {
...
/*    var $regex = '/^(\<code( .+)?\>)\n(.+)\n(\<\/code\>)(\s|$)/Umsi';*/
    var $regex = ';^<codehl(\s[^>]*)?>((?:(?R)|.*?)*)\n</codehl>(\s|$);msi';
    
    /**
    * 
    * Generates a token entry for the matched text.  Token options are:
    * 
    * 'text' => The full matched text, not including the <codehl></codehl> tags.
    * 
    * @access public
    *
