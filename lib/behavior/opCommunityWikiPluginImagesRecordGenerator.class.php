...
/**
 * opCommunityWikiPluginImagesRecordGenerator
 *
 * @package    opCommunityWikiPlugin
 * @subpackage behavior
 * @author     Kousuke Ebihara <ebihara@php.net>
 */
class opCommunityWikiPluginImagesRecordGenerator extends Doctrine_Record_Generator
{
  ...
  public function setUp()
  {
    ...
    $this->addListener(new opCommunityWikiPluginImagesListener($this->_options));
  }
}
